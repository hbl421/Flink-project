...
import hbl.tech.function.MyAggFunction;
import hbl.tech.watemark.MyWatermark;
...
public class DataReport {
    ...
    public static void main(String[] args) throws Exception {
        ...
        SingleOutputStreamOperator<Tuple4<String, String, String, Long>> resultData = filterData.assignTimestampsAndWatermarks(new MyWatermark())
                ...
                .allowedLateness(Time.seconds(30))// 允许迟到30秒
        ...
        outprop.setProperty("bootstrap.servers","bigdata2:9092");
        //设置事务超时时间
